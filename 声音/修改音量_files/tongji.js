...
{
	var unit_id     = "1854084";
	var client_ip   = "222.186.49.207";
	var server_time = "1345536269";
	var verify_code = "d57a3de5";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1854084/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
