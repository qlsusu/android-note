$(document).ready(function(){
    var option = {
        dir: 'http://hi.images.csdn.net/js/blog/SyntaxHighlighter/', //required. path of SyntaxHighlighter
		/**
		...
		*/
		...
		jspath: 'http://hi.images.csdn.net/js/blog/SyntaxHighlighter/Scripts/', //optional, default:dir + 'Scripts/'. path of SyntaxHighlighter Js files
		csspath: 'http://hi.images.csdn.net/js/blog/SyntaxHighlighter/Styles/', //optional, default:dir + 'Styles/'. path of SyntaxHighlighter Css files
		swfpath: 'http://hi.images.csdn.net/js/blog/SyntaxHighlighter/Scripts/' //optional, default:dir + 'Scripts/' path of SyntaxHighlighter clipboard.swf file
	};
    //jQuery.noConflict();
