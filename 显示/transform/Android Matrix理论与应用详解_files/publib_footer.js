...
document.write("</dl>");
document.write("</div>");
//document.write('<script id="noticeScript" type="text/javascript"  btnId="header_notice_num" wrapId="note1" count="5" subcount="5" src="http://static.csdn.net/rabbit/note/js/note.js"></script>');
