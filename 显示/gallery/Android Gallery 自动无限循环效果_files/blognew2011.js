	...
	"comment": {
		...
		'ads': {
			'0': {
				"type": "txt",
				"pos": "comment",
				"link": '[商讯]<a href="http://bf.sina.com.cn/newbf/zt/ysqm.html"  target="_blank">我有明星气势签名</a>',
				"status": {
					"adstart": "",
					"adend": "",
					"adclose": ""
			...
			'1': {
				"type": "txt",
				"pos": "comment",
				"link": '[商讯]<a href="http://sina.allyes.com/main/adfclick?db=sina&bid=277830,334360,339653&cid=0,0,0&sid=334533&advid=7567&camid=52451&show=ignore&url=http://all.vic.sina.com.cn/2011citicgongyi/index.php"  target="_blank">爱心签名换梦想，天天派奖</a>',
				"status": {
					"adstart": "",
					"adend": "",
					"adclose": ""
			...
			'2': {
				"type": "txt",
				"pos": "comment",
				"link": '[商讯]<a href="http://sina.allyes.com/main/adfclick?db=sina&bid=204720,299859,305135&cid=0,0,0&sid=298939&advid=358&camid=37389&show=ignore&url=http://blog.sina.com.cn/s/blog_705463570100phtd.html?tj=1"  target="_blank">提高博客人气新方法</a>',
				"status": {
					"adstart": "",
					"adend": "",
					"adclose": ""
...
"PDPS000000041399": {  // 300 * 250 博客正文页,画中画01
        'ad': 1,
        'adnum': 1,
        'rtt': 1,
        'ads': {
            '0': {
                "type": "swf",// 广告类型swf：flash类型, iframe：嵌入html页面广告，空字符串为其它形式广告
    ...
    "PDPS000000041400": {  // 300 * 500 博客正文页,画中画00
        'ad': 1,
        'adnum': 1,
        'rtt': 1,
        'ads': {
