...
'validate-email':'请填写有效的邮件地址,如 username@example.com.',
...
Validator.bad_words=[/fuck/i,/shit/i,/QQ群/i,/MSN群/i,/求(助|救)/,/(跪|裸)求/,/急急|我很急|紧急寻求/,/在线等/,/救(命|我|急|救)/,/急(!|！)/,/(高手|高人|大虾|大侠|达人|前辈|快来|没有人)(指点|解答|帮忙|帮帮|指教|赐教|提点|不吝赐教|到哪)/,/(我是|帮帮)(新手|小弟|菜鸟)/,/帮帮忙/,/万分火急/,/我顶|顶上去|好贴要顶|帮顶|看看先|顶一下/,/有*没有人(回答|帮忙|关注|知道啊|回复)/,/教主|装B|装13/,/关注(ing|中)/i,/收藏先/,/先收藏/,/收藏了/,/谢谢楼主/,/图书兼职作者/,/传智播客/,/FineReport/i];
Validator.prototype={
...
this.form.spinner.src='http://www.javaeye.com/images/spinner.gif';
...
if(!$A(['jpg','jpeg','bmp','png','gif','rar','zip','tar','gz','jar','war','bz2']).any(function(extName){return new RegExp('\\.'+extName+'$','i').test(ele.value);})){
...
$('d'+id).innerHTML="<h3><img src='/images/spinner.gif'/><br/><span>...</span></h3>";
if($('digg_bottom')!=undefined){
$$('#digg_bottom div').each(function(div){div.innerHTML="<img src='/images/spinner.gif'/>";});
new Ajax.Request(url,{asynchronous:true,evalScripts:true,parameters:{"id":id,"bottom":true}});
}else{
new Ajax.Request(url,{asynchronous:true,evalScripts:true,parameters:{"id":id}});
}
}
